...
class HuaweiVendor:
    ...
    # PON Port OIDs
    PON_PORT_OIDS = {
        'temperature': '1.3.6.1.4.1.2011.6.128.1.1.2.43.1.2',
        'voltage': '1.3.6.1.4.1.2011.6.128.1.1.2.43.1.3',
        'tx_power': '1.3.6.1.4.1.2011.6.128.1.1.2.43.1.4',
        'rx_power': '1.3.6.1.4.1.2011.6.128.1.1.2.43.1.5',
        'tx_bias': '1.3.6.1.4.1.2011.6.128.1.1.2.43.1.6',
    ...
    # ONU OIDs
    ONU_OIDS = {
        'serial_number': '1.3.6.1.4.1.2011.6.128.1.1.2.43.1.3',
        ...
        'distance': '1.3.6.1.4.1.2011.6.128.1.1.2.53.1.1',
        'temperature': '1.3.6.1.4.1.2011.6.128.1.1.2.51.1.8',
        'voltage': '1.3.6.1.4.1.2011.6.128.1.1.2.51.1.9',
    }
    ...
    def parse_power(value):
        ...
        if value is None or value == 0 or value == 65535:
            return None
        try:
            return (float(value) - 10000) / 100.0
        except:
            return None
